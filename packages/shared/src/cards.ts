...
export const NEXUS_MAX_HEALTH = 20;
export const NEXUS_POSITION_PLAYER0: { x: 1; y: 3 } = { x: 1, y: 3 }; // Player 0 backline center
export const NEXUS_POSITION_PLAYER1: { x: 1; y: 0 } = { x: 1, y: 0 }; // Player 1 backline center
